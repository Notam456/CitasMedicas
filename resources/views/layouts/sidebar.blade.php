<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        <a href="{{route('dashboard')}}" class="navbar-brand text-center w-100 d-block mb-3">
            <h3 class="text-primary mb-0">SAGECIM</h3>
        </a>
        ...
        <div class="navbar-nav w-100">
            ...
            @can('Patologia')
            <a href="{{ route('patologias.index') }}" class="nav-item nav-link"><i class="bi bi-file-medical-fill me-2"></i>Patología</a>
            @endcan
