            ...
            <form action="" method="POST" id="editForm">
                ...
                <div class="modal-body" style="max-height: 65vh; overflow-y: auto;">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="diagnostico_libre" id="edit_diagnostico_libre" class="form-control" rows="2"></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <button type="button" class="btn btn-sm btn-secondary mt-1" id="edit_add_medicamento"><i class="bi bi-plus-circle"></i> Agregar medicamento</button>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <button type="button" class="btn btn-sm btn-secondary mt-1" id="edit_add_referencia"><i class="bi bi-plus-circle"></i> Agregar referencia</button>
                    </div>
                </div>
